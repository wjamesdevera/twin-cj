...
INSERT INTO "new_feedbacks" ("bookingId", "created_at", "feedback_id", "feedback_status_id", "name", "text", "updated_at") SELECT "bookingId", "created_at", "feedback_id", "feedback_status_id", "name", "text", "updated_at" FROM "feedbacks";
