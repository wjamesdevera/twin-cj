...
CREATE TABLE "new_day_tour_activities" (
    ...
    CONSTRAINT "day_tour_activities_additionalFeeId_fkey" FOREIGN KEY ("additionalFeeId") REFERENCES "additional_fees" ("additional_fee_id") ON DELETE SET NULL ON UPDATE CASCADE
);
