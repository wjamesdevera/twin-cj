...
const AdminAccountsPage = () => {
  ...
  const [adminAccounts, setAdminAccounts] = useState([
    { id: 1, firstName: "John", lastName: "Doe", email: "johndoe@example.com", phone: "+1 234 567 890" },
    { id: 2, firstName: "Jane", lastName: "Smith", email: "janesmith@example.com", phone: "+1 987 654 321" },
  ]);
  ...
  const handleConfirmDelete = () => {
    if (selectedId !== null) {
      setAdminAccounts((prev) => prev.filter((account) => account.id !== selectedId));
    ...
    <div className={styles.page_container}>
      ...
      <div className={`${styles.main_content} ${isSidebarOpen ? "" : styles.sidebar_collapsed}`}>
        ...
        <div className={styles.add_user_container}>
          <CustomButton label="Add User" href="/admin/admin_accounts/add_account" variant="primary" />
        </div>
